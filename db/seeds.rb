...
Player.create(team: team, name: 'zai', handle: 'zai', core: true)
Player.create(team: team, name: 'ppd', handle: 'ppd', core: true)
...
Player.create(team: team, name: 'Banana', handle: 'Banana', core: true)
Player.create(team: team, name: 'Sansheng', handle: 'Sansheng', core: true)
...
Player.create(team: team, name: 'Fenrir', handle: 'Fenrir', core: true)
Player.create(team: team, name: 'fy', handle: 'fy', core: true)
...
Player.create(team: team, name: 'LaNm', handle: 'LaNm', core: true)
Player.create(team: team, name: 'X!!', handle: 'X!!', core: true)
...
Player.create(team: team, name: 'DDC', handle: 'DDC', core: true)
Player.create(team: team, name: 'Yao', handle: 'Yao', core: true)
Player.create(team: team, name: 'DD', handle: 'DD', core: true)
